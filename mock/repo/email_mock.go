...
//
//	mockgen -source=internal/repo/email.go -destination=mock/repo/email_mock.go -package=repo
//
...
func (mr *MockEmailRepoMockRecorder) StoreVerificationEmail(c, userId, code, content, ttl any) *gomock.Call {
...
func (mr *MockEmailRepoMockRecorder) VerifyCode(c, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
