...
//
//	mockgen -source=internal/repo/user.go -destination=mock/repo/user_mock.go -package=repo
//
...
func (mr *MockUserRepoMockRecorder) CreateUser(c, user any) *gomock.Call {
...
func (mr *MockUserRepoMockRecorder) GenerateUniqueUsername(c, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepoMockRecorder) GetUserByEmail(c, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepoMockRecorder) GetUserByUsername(c, username any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepoMockRecorder) IncrRank(c, userId, currentRank, deltaRank any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUserRepoMockRecorder) UpdateEmailStatus(c, userId, emailStatus any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
