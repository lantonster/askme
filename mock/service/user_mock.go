...
//
//	mockgen -source=internal/service/user.go -destination=mock/service/user_mock.go -package=service
//
...
func (mr *MockUserServiceMockRecorder) RegisterUserByEmail(c, req any) *gomock.Call {
...
func (mr *MockUserServiceMockRecorder) VerifyEmail(c, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
