...
//
//	mockgen -source=internal/repo/activity.go -destination=mock/repo/activity_mock.go -package=repo
//
...
func (mr *MockActivityRepoMockRecorder) CreateActivity(c, activity any) *gomock.Call {
...
func (mr *MockActivityRepoMockRecorder) GetActivityByType(c, typ any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
