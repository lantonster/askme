...
func Init() *server.Server {
	...
	repoRepo := repo.NewRepo(configRepo, emailRepo, siteInfoRepo, userRepo)
	...
	serviceService := service.NewService(configService, emailService, siteInfoService, uploadsService, userService)
