...
//
//	mockgen -source=internal/service/email.go -destination=mock/service/email_mock.go -package=service
//
...
func (mr *MockEmailServiceMockRecorder) Send(c, email, subject, body any) *gomock.Call {
...
func (mr *MockEmailServiceMockRecorder) SendRegisterVerificationEmail(c, userId, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailServiceMockRecorder) VerifyUrlExpired(c, code any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
