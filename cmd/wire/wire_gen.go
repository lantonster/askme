...
func Init() *server.Server {
	...
	repoRepo := repo.NewRepo(authRepo, configRepo, emailRepo, siteInfoRepo, userRepo)
	...
	serviceService := service.NewService(authService, configService, emailService, siteInfoService, uploadsService, userService)
