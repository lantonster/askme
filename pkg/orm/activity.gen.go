...
func newActivity(db *gorm.DB, opts ...gen.DOOption) activity {
	...
	_activity.CancelledAt = field.NewInt64(tableName, "cancelled_at")
	_activity.UserId = field.NewInt64(tableName, "user_id")
	_activity.TriggerUserId = field.NewInt64(tableName, "trigger_user_id")
	_activity.ObjectId = field.NewInt64(tableName, "object_id")
	_activity.OriginalObjectId = field.NewInt64(tableName, "original_object_id")
	_activity.RevisionId = field.NewInt64(tableName, "revision_id")
	_activity.Rank = field.NewInt64(tableName, "rank")
...
type activity struct {
	...
	CancelledAt      field.Int64
	UserId           field.Int64
	TriggerUserId    field.Int64
	ObjectId         field.Int64
	OriginalObjectId field.Int64
	RevisionId       field.Int64
	Rank             field.Int64
	Type             field.String
...
func (a *activity) updateTableName(table string) *activity {
	...
	a.CancelledAt = field.NewInt64(table, "cancelled_at")
	a.UserId = field.NewInt64(table, "user_id")
	a.TriggerUserId = field.NewInt64(table, "trigger_user_id")
	a.ObjectId = field.NewInt64(table, "object_id")
	a.OriginalObjectId = field.NewInt64(table, "original_object_id")
	a.RevisionId = field.NewInt64(table, "revision_id")
...
func (a *activity) fillFieldMap() {
	...
	a.fieldMap["trigger_user_id"] = a.TriggerUserId
	a.fieldMap["object_id"] = a.ObjectId
	a.fieldMap["original_object_id"] = a.OriginalObjectId
	a.fieldMap["revision_id"] = a.RevisionId
