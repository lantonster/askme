...
//
//	mockgen -source=internal/repo/site_info.go -destination=mock/repo/site_info_mock.go -package=repo
//
...
func (mr *MockSiteInfoRepoMockRecorder) FirstSiteInfoByType(c, typ any) *gomock.Call {
